...
using PhotoCli.Services.Implementations; // Asegúrate de que esta línea esté, si ConsoleWriter está aquí
using SharpExifTool;
using System.IO.Abstractions;
using System.Security.Cryptography;
using System.Text;
using System.Linq;
using Spectre.Console; // Necesario para usar Markup.Escape
