...
public class FolderRenamerService : IFolderRenamerService
{
	...
	public FolderRenamerService(ToolOptions options, ILogger<FolderRenamerService> logger)
	{
		_options = options;
		_logger = logger;
		_ignoredFolders = new List<string> { _options.NoAddressFolderName, _options.NoPhotoTakenDateFolderName, _options.NoAddressAndPhotoTakenDateFolderName, _options.NoAuthorFolderName, _options.NoDeviceFolderName, _options.NoAuthorAndDeviceAndPhotoTakenDateFolderName, _options.NoAuthorAndDeviceFolderName };
	}
